...
func GetToken(ctx context.Context, clientID string, issuerURL string, configOptions ...client.Option) (*client.Token, error) {
	...
	c, err := client.NewClient(ctx, conf, configOptions...)
	if err != nil {
